...
#shape = wf.CyclicStaircaseVoltammetry(Eini = -0.3, Eupp = 0.8, Elow = -0.65, dE = 0.002, sr = 0.5, ns = 1, osf = 2E7)
...
instance = op.Operations(shape, input, MA = False, window = 50000, step = 1000, CS = True, alpha = 0.9)

'''6. VISUALISE THE ANALYSIS'''
plt.Plotter(shape, instance, display = True, save = False)
