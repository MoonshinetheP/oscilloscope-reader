...
shape = wf.CyclicLinearVoltammetry(Eini = 0.35, Eupp = 1.45, Elow = 0, dE = 0.001, sr = 0.5, ns = 1, osf = 1000000)
...
data = fo.Oscilloscope(filedialog.askopenfilename(), cf = -0.000000001)

#data = sim.Capacitance(shape, Cd = 0.000050, Ru = 250)

'''5. PERFORM ANALYSIS ON THE DATA FILE'''
analysis = op.Operations(shape, data, MA = False, window = 100000, step = 1000, CS = True, center = 0.5, range = 0.98)
